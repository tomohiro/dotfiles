...
"  Last Modified: 2010-06-06 11:54
"        Version: 2.20
"================================================================================
...
if MyGrep_MenuBar
  ...
  exec 'amenu <silent> 41.331 '.s:menu.'.VGrep(&V)<Tab>'.s:MyGrep_Key.'v  :QFVGrep!<CR>'
  ...
  exec 'amenu <silent> 41.331 '.s:menu.'.VGrepadd(&V)<Tab>'.s:MyGrep_Key.'V  :QFVGrepadd!<CR>'
  if MyGrep_MenuBar == 1
